...
class CaseContextController extends Controller
{
    ...
    {
        $e = $request->syncEnvelope();
        $result = $sync->sync($case, $request->user(), 'case_context', $e['client_operation_id'], $e['base_lock_version'], $request->sectionData(), $e['resolution'], $e['confirmed']);
        $model = $result['model'];
