...
syncAvailability.definition = {
    methods: ["put"],
    url: '/student/cases/{case}/medication-chart-availability',
} satisfies RouteDefinition<["put"]>
...
const CaseMedicationController = { store, sync, destroy, syncAvailability }

export default CaseMedicationController