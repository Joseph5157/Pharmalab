 ...
 * @route '/admin'
 */
export const administrator = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/admin'
 */
administrator.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: administrator.url(options),
    method: 'head',
})
 ...
 * @route '/admin'
 */
    const administratorForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/admin'
 */
        administratorForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: administrator.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/admin'
 */
        administratorForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
