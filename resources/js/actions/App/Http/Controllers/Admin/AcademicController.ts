 ...
 */
export const storeProgramme = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/admin/programmes'
 */
storeProgramme.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: storeProgramme.url(options),
    method: 'post',
})
 ...
 * @route '/admin/programmes'
 */
    const storeProgrammeForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/admin/programmes'
 */
        storeProgrammeForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: storeProgramme.url(options),
            method: 'post',
        })
 ...
 * @route '/admin/cohorts'
 */
export const storeCohort = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/admin/cohorts'
 */
    const storeCohortForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/admin/cohorts'
 */
        storeCohortForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: storeCohort.url(options),
            method: 'post',
        })
