 ...
 */
export const syncSpike = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/student/sync-spike'
 */
    const syncSpikeForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/student/sync-spike'
 */
        syncSpikeForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: syncSpike.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/student/sync-spike'
 */
        syncSpikeForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
